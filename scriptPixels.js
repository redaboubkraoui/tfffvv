...
if (tblid) {
var tblscripi = "<script>  _tfa.push({notify: 'event', name: 'add_to_cart', id: "+tblid+",'value':"+productData.value+",'content_name:'"+productData.content_name+",'currency:'"+productData.currency+"});</script>"
