...
if (tblid) {
var tblscripi = "<script>  _tfa.push({notify: 'event', name: 'add_to_cart', id: "+tblid+",'value':"+productData.price+",'content_name:'"+productData.product.title+",'currency:'"+productData.currency+"});</script>"
