...
var _slicedToArray = function () {
        function t(t, e) {
            var i = [],
                ...
                r = undefined;
            try {
                for (var n, o = t[Symbol.iterator](); !(a = (n = o.next()).done) && (i.push(n.value), !e || i.length !== e); a = !0);
            } catch (l) {
                s = !0, r = l
            } finally {
                try {
...
! function (t, e) {
    ...
    t.addEventListener || (s([e, t]), "Element" in t ? t.Element.prototype.addEventListener = a : (e.attachEvent("onreadystatechange", function () {
        ...
        if ("Element" in t) {
            var e = "classList",
                ...
                c = function (t) {
                    for (var e = r.call(t.getAttribute("class") || ""), i = e ? e.split(/\s+/) : [], a = 0, s = i.length; a < s; a++) this.push(i[a]);
            ...
            if (o[i] = Error[i], h.item = function (t) {
                    ...
                    var t, e, i = arguments,
                        ...
                        r = !1;
                    do {
                        for (t = i[a] + "", e = l(this, t); - 1 !== e;) this.splice(e, 1), r = !0, e = l(this, t)
                    } while (++a < s);
    ...
    function () {
        function t() {
            (l = new w).getEnableStatus() && (o = new p("products", window.document, null)), i = 0, a = 10, s = !1, r = 0, n = 0, c = 0, h = !1
        }
        ...
        var i = undefined,
            ...
            p = function () {
                function t(e, i, a) {
                    _classCallCheck(this, t), this.instanceType = e, this.currentDocument = i, this.storeSlug = "bayershops", this.hasOnlyDefaultVariant = !1, this.eventsRegistered = !1, this.multiLingualInfo = null, this.untranslatedData = null, this.untranslatedFetchStatus = "none", this.instanceSubType = this.instanceType, a && "undefined" != typeof a.instance_sub_type && (this.instanceSubType = a.instance_sub_type), this.setInstanceGlobals(), this.fetchInformationFromJs()
                }
                return _createClass(t, [{
                    ...
                    value: function (t, e) {
                        var i = t.getAttribute("data-navigation"),
                            ...
                            r = a.querySelector('[data-navigation="right"]'),
                            n = a.querySelector("ul.swatch-view"),
                            o = n.querySelectorAll("li.swatch-view-item:not(.hidden)");
                        a.style.paddingLeft = "0", a.style.paddingRight = "0";
                        var l = 5,
                            c = n.scrollWidth - n.clientWidth,
                            h = 20;
                        if (c <= l) return s.style.display = "none", void(r.style.display = "none");
                        if (a.style.paddingLeft = "", a.style.paddingRight = "", s.style.display = "", r.style.display = "", !e) {
                            if ("undefined" != typeof n.offsetLeft) {
                                for (var u = 0; u < o.length; u++) {
                                    var d = o[u].offsetLeft - n.offsetLeft;
                                    d > n.offsetWidth || (h = d)
                                }
                                0 == h && (h = n.offsetWidth)
                            }
                            var p = n.scrollLeft;
                            "left" == i ? (p -= h, n.scrollLeft = p, a.style.paddingRight = "", r.style.display = "") : "right" == i && (p += h, n.scrollLeft = p, a.style.paddingLeft = "", s.style.display = ""), p <= l ? (a.style.paddingLeft = "0px", s.style.display = "none") : c - p <= l && (a.style.paddingRight = "0px", r.style.display = "none")
                        }
                    }
                }, {
                        ...
                        if (this.uiElements.getIsSwatchRootDisplayed() || this.hasOnlyDefaultVariant) {
                            ...
                            Object.entries(i).forEach(function (e) {
                                var i = _slicedToArray(e, 2),
                                    ...
                                    l = "group" + o.id;
                                if ("length" != n) {
                                    for (var c = 0; c < r[o.display_position].length; c++) {
                                        var h = r[o.display_position][c];
                                    ...
                                    t.selectedProductGroup && t.selectedProductGroup == l || t.generateProductGroupsUI(s, a, l, o), r[o.display_position].push(o)
                                }
                            })
                    ...
                    value: function (t, e, i, a) {
                        var s = !1,
                            r = a.option_name ? a.option_name : "",
                            n = {
                                available_count: 0,
                                name: this.getTranslation(r),
                                untranslated_name: r,
                        ...
                        if (0 == l && o++, "hidden" != n.view_type)
                            for (var c = 0; c < a.option_values.length; c++) {
                                ...
                                if ("undefined" == typeof h.available && (h.available = !0), d || (d = {
                                    ...
                                    g += this.getCurrentLanguageSlug() + "/products/" + h.handle, ("custom_image" == n.view_type || "drop_down" == n.view_type && "with_custom_image" == n.drop_down_type) && (d = {
                        ...
                        s && this.generateProductGroupsUIHelper(n.view_type, i, e, o)
                    }
                }, {
                    ...
                    value: function (t, e, i, a) {
                        ...
                        if (s) {
                            if (0 != a) {
                                var r = s.closest("[option-name]").getAttribute("option-name"),
                                    n = this.uiElements.getMinifiedHTML(r, a, this.productInfoTree.getProductInfo());
                                s.closest("ul.swatch-view").appendChild(n)
                            }
                    ...
                    value: function () {
                        var e = this,
                            ...
                            s = !1,
                            r = !1,
                            n = this.currentDocument.getAttribute("swatch-generated");
                        if ("none" == n) {
                            var o = this.currentDocument.querySelector('a[href*="/products/"], [data-href]');
                            o && (o.hasAttribute("href") ? n = o.getAttribute("href") : o.hasAttribute("data-href") && (n = o.getAttribute("data-href")), n = this.extractProductHandle(n))
                        }
                        var l = setInterval(function () {
                            if (a >= 10 && (s = !0), s) y(l);
                                ...
                                if (o) {
                                    ...
                                    if (c) {
                                        if (c == n) return m("Quick view swatches already present"), void(s = !0);
                                    ...
                                    if ("" != e.clientSpecs.getSelectors().json_data_selector) o.querySelector(e.clientSpecs.getSelectors().json_data_selector) && (r = !0);
                                    o.setAttribute("swatch-generated", n), i = new t("products", o, {
                                        instance_sub_type: "quick_view"
                                    })
                                }
                            } else {
                                if (!i.readyToInit() && !r) return m(["QuickView", "Requesting data for product handle: " + n]), e.executeFetch({
                                    url: e.getCurrentLanguageSlug() + "/collections/all/products/" + n + ".js",
                                    path_name: null,
                                    allow_processing: !1,
                                    callback: function (t) {
                                ...
                                try {
                                    (i.readyToInit() || i.hasOnlyDefaultVariant) && (m(["QuickView", "Init swatches generation for product: " + n]), i.detectAndInitialize(), s = !0)
                                } catch (u) {
                        ...
                        if (i && e.featured_image ? a = !0 : !i && e.featured_image && e.featured_image.secondary_src && (a = !0), t && a)
                            if ("IMG" == t.tagName) {
                                ...
                                if (t.currentSrc && (s = t.currentSrc), !s && t.hasAttribute("data-srcset")) {
                                    ...
                                    if ((r = r.split(",")).length > 1) s = r[parseInt((r.length - 1) / 2)].trim().split(" ")[0];
                                    else if (1 == r.length) {
                                        s = r[0].trim().split(" ")[0]
                                    }
                                }
                                ...
                                var n = null;
                                n = i ? this.generateImageURL(s, e.featured_image.src) : this.generateImageURL(s, e.featured_image.secondary_src), t.setAttribute("src", n), t.setAttribute("srcset", n), t.setAttribute("data-srcset", n)
                            } else {
                                var o = /url\((\S*)\)/gm;
                                ...
                                if (l) {
                                    ...
                                    n = null;
                                    n = i ? this.generateImageURL(s, e.featured_image.src) : this.generateImageURL(s, e.featured_image.secondary_src), t.setAttribute("data-bgset", n), t.style.backgroundImage ? t.style.backgroundImage = "url(" + n + ")" : t.style.background = "url(" + n + ")"
                                }
                            }
                        else if (t)
                            if ("IMG" == t.tagName && t.hasAttribute("img-orig-src")) {
                                n = t.getAttribute("img-orig-src");
                                t.setAttribute("src", n), t.setAttribute("srcset", n), t.setAttribute("data-srcset", n)
                            } else if (t.hasAttribute("img-orig-src")) {
                            n = t.getAttribute("img-orig-src");
                            t.setAttribute("data-bgset", n), t.style.backgroundImage ? t.style.backgroundImage = "url(" + n + ")" : t.style.background = "url(" + n + ")"
                        }
                    ...
                    value: function (t, e, i, a) {
                        ...
                        return r[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + i) + (r[1] && "00" != r[1] ? a + r[1] : s)
                    }
                }, {
                    key: "updateSKU",
                    value: function (t, e) {
                    ...
                    value: function (t, e) {
                        ...
                        if (t && e.price) {
                            ...
                            if ("undefined" != typeof i[s] && (s = i[s]), a = (a = (a = (a = (a = a.replace(/{price_token}/gm, s)).replace(/{price_code}/gm, Shopify.currency.active)).replace(/{price_amount_actual}/gm, r)).replace(/{price_amount}/gm, this.formatWithDelimiters(r))).replace(/{product_id}/gm, o), null != n && n > r) {
                                var l = Math.floor(r / n * 100);
                                l = 100 - l, a = (a = (a = (a = (a = (a = a.replace(/{(?:compare_at_display|display_on_sale)}/gm, "")).replace(/{hide_on_sale}/gm, 'style="display:none;"')).replace(/{compare_at_price_actual}/gm, n)).replace(/{compare_at_price}/gm, this.formatWithDelimiters(n))).replace(/{price_difference}/gm, this.formatWithDelimiters(n - r))).replace(/{percentage_difference}/gm, l), t.classList.add("sa-variant-on-sale")
                    ...
                    value: function (t, e) {
                        if (this.readyToInit() || this.hasOnlyDefaultVariant) {
                            for (var i = "top", a = !1, s = t.querySelectorAll("[option-target]"), r = 0; r < s.length; r++) {
                                var n = !1,
                                    o = s[r];
                                if (!a) {
                                    var l = o.getAttribute("option-target");
                                    o.hasAttribute("type-group") ? l == e ? (a = !0, n = !0) : 0 : (0, i = "bottom")
                                }
                                n || this.removeElement(o)
                            }
                    ...
                    value: function (t, e, i) {
                        var a = e.getAttribute("option-target"),
                            s = e.parentNode,
                            r = t.variants[0];
                        this.currentDocument.removeAttribute("swatch-current-variant"), this.currentDocument.hasAttribute("swatch-default-variant") && this.currentDocument.setAttribute("swatch-default-variant", r.id), this.currentDocument.setAttribute("swatch-generated", t.handle), this.productChangeRestructure(s, a), this.dispatchCustomEvent(this.currentDocument, "product:changed", {
                            productID: "" + t.id,
                            previousProductID: i
                        });
                        var n = this.getInstanceConfig().data_selectors,
                            o = null,
                            l = null,
                            c = {
                                id: t.id,
                        ...
                        t.featured_image ? (c.featured_image.src = t.featured_image, c.featured_image.secondary_src = t.featured_image) : t.images && t.images.length >= 1 && (c.featured_image.src = t.images[0], c.featured_image.secondary_src = t.images[0]), t.images && t.images.length >= 2 && (c.featured_image.secondary_src = t.images[1]), "" != n.title && (l = this.currentDocument.querySelectorAll(n.title), Object.entries(l).forEach(function (t) {
                            var e = _slicedToArray(t, 2),
                                i = e[0],
                                a = e[1];
                            "length" != i && (a.innerHTML = c.title)
                        })), "" != n.price && Shopify && Shopify.currency && (o = this.currentDocument.querySelector(n.price), this.updatePrice(o, c)), "" != n.sku && (o = this.currentDocument.querySelector(n.sku), this.updateSKU(o, c)), "" != n.featured_image && (o = this.currentDocument.querySelector(n.featured_image), this.updateVariantImage(o, c, !0)), "" != n.featured_image && "" != n.secondary_image && (o = this.currentDocument.querySelector(n.secondary_image), this.updateVariantImage(o, c, !1)), "" != n.url && (l = this.currentDocument.querySelectorAll(n.url), Object.entries(l).forEach(function (t) {
                            var e = _slicedToArray(t, 2),
                                i = e[0],
                                a = e[1];
                            if ("length" != i) {
                                if (a.hasAttribute("href") && a.setAttribute("href", c.url), a.hasAttribute("data-href") && a.setAttribute("data-href", c.url), "" != n.link_pid_attribute) {
                                    var s = n.link_pid_attribute;
                                    a.hasAttribute(s) && a.setAttribute(s, c.id)
                                }
                                if ("" != n.link_vid_attribute) {
                                    var r = n.link_vid_attribute;
                                    a.hasAttribute(r) && a.setAttribute(r, c.variant_id)
                                }
                            }
                        }));
                        ...
                        Object.entries(u).forEach(function (t) {
                            ...
                            if ("length" != i && a.hasAttribute(d)) {
                                var s = a.getAttribute(d),
                                    r = c.handle;
                                s.includes("/products/") && (r = c.url), a.setAttribute(d, r)
                            }
                        })
                    }
                }, {
                            ...
                            if (t && "select" == u.getAttribute("type")) {
                                ...
                                if (t && u.hasAttribute("swatch-option")) {
                                    ...
                                    if (this.selectionAllowed || this.isEventTrusted(t, !0)) {
                                        this.selectionAllowed = !0, this.uiElements.selectSwatch(s, u, a), r = this.getCurrentOptionForCollection(), o = this.productInfoTree.getVariantInfoFromOptions(r);
                                        var v = !0,
                                            ...
                                            Object.entries(b).forEach(function (e) {
                                                ...
                                                if ("length" != a && s && o.id) {
                                                    var r = s.getAttribute("href"),
                                                        n = t.exec(r),
                                                        l = "variant=" + o.id;
                                                    if (n || (n = t.exec(r.toString())), n ? r = r.replace(n[0], l) : r.includes("?") ? r += "&" + l : r += "?" + l, s.hasAttribute("href") && s.setAttribute("href", r), s.hasAttribute("data-href") && s.setAttribute("data-href", r), "" != y.link_vid_attribute) {
                                ...
                                this.readyToInit() ? (this.uiElements.getIsSwatchRootDisplayed() || this.uiElements.renderSwatchRoot(this.uiElements.getSwatchRoot(this.productInfoTree.getOptions()), this.getCorrectSwatchRoot(), "top" == this.getInstanceConfig().swatch_position), r = this.getCurrentOptionForCollection(), n = this.productInfoTree.getNodeByOptions(r), Object.entries(n).forEach(function (t) {
                                    var a = _slicedToArray(t, 2),
                                        ...
                                        n = a[1];
                                    if (null == i) {
                                        var o = e.uiElements.getViewByType(n.view_type).getView(s, n),
                                            l = e.uiElements.renderNormal(s, o, e.currentDocument);
                                        1 == n.data.length && "null" == n.data[0].value && l.length > 0 && l[0].closest && (l[0].closest("div.swatch-single").style.display = "none"), m("Generated UI for - " + s);
                                        var c = r[s],
                                            h = !1,
                                        ...
                                        Object.entries(l).forEach(function (t) {
                                            var a = _slicedToArray(t, 2),
                                                ...
                                                r = a[1];
                                            if ("length" != s) {
                                                if (null != u && ("variant_image" == n.view_type || "custom_image" == n.view_type || "button" == n.view_type) && s >= u) {
                                                    var o = r.closest("li.swatch-view-item");
                                                ...
                                                if (setTimeout(function () {
                                                        ...
                                                        r.classList.add(t)
                                                    }, 128), e.uiElements.isDropDown(r.tagName)) {
                                                    d = r.value;
                                                    for (var p = r.querySelectorAll("option"), g = 0; g < p.length; g++) p[g].getAttribute("value") == c && (d = c, r.value = c)
                                                } else d = r.getAttribute("orig-value");
                                                if (d == c && (h = !0, e.uiElements.isDropDown(r.tagName) ? e.dispatchEvent("change", r) : e.dispatchEvent("virtual_click", r)), s == l.length - 1) {
                                                    if (null != u && ("variant_image" == n.view_type || "custom_image" == n.view_type || "button" == n.view_type)) {
                                                        var w = l.length - u;
                                                        if (w > 0) {
                                                            var v = r.closest("[option-name]").getAttribute("option-name"),
                                                                m = e.uiElements.getMinifiedHTML(v, w, e.productInfoTree.getProductInfo());
                                                            r.closest("ul.swatch-view").appendChild(m)
                                                        }
                                                    }
                                                    if ("slide" == e.clientSpecs.getSwatchPresentation("collections").style) {
                                                        var f = r.closest(".swatch-navigable");
                                                        if (f) {
                                                            var y = f.querySelector(".swatch-navigation");
                                                            y && y.click()
                                                        }
                                                    }
                                                    if (!e.selectionAllowed && "SELECT" == r.tagName) {
                                                        var b = r.closest("[option-name]").getAttribute("option-name"),
                                                            _ = e.getTranslation(e.doNotSelectAnOption.text);
                                                        _ = _.replace(/{{ option_name }}/gm, b);
                                                        var S = document.createElement("option");
                                                        S.value = r.value, S.innerHTML = _, r.insertBefore(S, r.options[0]), r.selectedIndex = 0, r.setAttribute("data-selected", !1)
                                                    }
                    ...
                    value: function () {
                        ...
                        var s = this.currentDocument.querySelectorAll(".swatches .swatch-selector"),
                            r = this.productInfoTree.getOptions(),
                            n = {},
                            o = {},
                            l = null;
                        for (a = 0; a < s.length; a++) {
                            var c = s[a].getAttribute("swatch-option");
                            null == l && (l = c), "undefined" == typeof o[c] && (o[c] = a), s[a].classList.contains("swatch-selected") && (n[c] = s[a].getAttribute("orig-value"), this.uiElements.isDropDown(s[a].tagName) && (n[c] = s[a].value)), l == c || n[l] || (n[l] = s[o[l]].getAttribute("orig-value"), this.uiElements.isDropDown(s[o[l]].tagName) && (n[l] = s[o[l]].value)), l = c
                        }
                        var h = {};
                        for (a = 0; a < r.length; a++) {
                            n[c = "option" + (a + 1)] || (n[c] = r[a].values[0], "object" == typeof n[c] && n[c].title && (n[c] = n[c].title)), h[c] = n[c]
                        }
                        return h
                    }
                }, {
                    ...
                    value: function (t, e) {
                        ...
                        Object.entries(a).forEach(function (a) {
                            var s = _slicedToArray(a, 2),
                                ...
                                n = s[1];
                            if ("length" != r)
                                if (n.setAttribute("disabled", "disabled"), "" != e.trim() && (n.className = e), "INPUT" == n.tagName) n.hasAttribute("original-text") || n.setAttribute("original-text", n.value), n.value = t;
                                else if ("BUTTON" == n.tagName) {
                                var o = n.querySelector(i.clientSpecs.getSelectors().add_to_cart_text_selector);
                        ...
                        Object.entries(e).forEach(function (e) {
                            ...
                            if ("length" != a)
                                if (s.removeAttribute("disabled"), t.clientSpecs.getSelectors().add_to_cart_enabled_classes && "" != t.clientSpecs.getSelectors().add_to_cart_enabled_classes.trim() && (s.className = t.clientSpecs.getSelectors().add_to_cart_enabled_classes), "INPUT" == s.tagName && s.hasAttribute("original-text")) {
                                    var r = s.getAttribute("original-text");
                                    s.removeAttribute("original-text"), s.value = r
                                } else if ("BUTTON" == s.tagName) {
                                var n = s.querySelector(t.clientSpecs.getSelectors().add_to_cart_text_selector);
                                if (n && n.hasAttribute("original-text")) {
                                    r = n.getAttribute("original-text");
                                    n.removeAttribute("original-text"), n.innerHTML = r
                                }
                            }
                        })
                    }
                            ...
                            for (var s = 0; s < i.length; s++)
                                if (t.hasAttribute(i[s])) {
                                    ...
                                    if (r.match(RegExp("option\\d+", "gi"))) {
                                        a = r, this.themeSupportConfig.attribute_name = i[s];
                                        break
                                    }
                                }
                        ...
                        for (var t = {}, e = this.currentDocument.querySelectorAll(this.themeSupportConfig.option_selector), i = 0; i < e.length; i++)
                            if (e[i].classList.contains("is-selected") || 1 == e[i].checked) {
                                ...
                                if ("button" == e[i].getAttribute("type") && (s = e[i].getAttribute("data-value")), e[i].hasAttribute("data-option-value") && (s = e[i].getAttribute("data-option-value")), e[i].hasAttribute("data-option-position")) {
                                    var r = e[i].getAttribute("data-option-position");
                                    a = "option" + r, r.includes("option") && (a = r)
                                }
                                t[a] = s
                            }
                        ...
                        for (var i = this.currentDocument.querySelectorAll(this.themeSupportConfig.option_selector), a = 0; a < i.length; a++) {
                            ...
                            if ((s = this.getOptionIndexKey(i[a], s)) == t) {
                                if (i[a].hasAttribute("orig-value"))
                                    for (var r = i[a].options, n = 0; n < r.length; n++) {
                                        var o = r[n];
                    ...
                    value: function (t, e) {
                        for (var i = this.currentDocument.querySelectorAll(this.themeSupportConfig.option_selector), a = 0; a < i.length; a++) {
                            ...
                            var n = !i[a].checked;
                            if (this.doNotSelectAnOption.status && this.doNotSelectAnOption.trusted_event_detected && (n = !0), n && s == t && r == e) {
                    ...
                    value: function (t, e) {
                        for (var i = this.currentDocument.querySelectorAll(this.themeSupportConfig.option_selector), a = 0; a < i.length; a++) {
                            var s = "option" + (a + 1),
                                r = i[a].value;
                            if ("button" == i[a].getAttribute("type") && (r = i[a].getAttribute("data-value")), i[a].hasAttribute("data-option-value") && (r = i[a].getAttribute("data-option-value")), i[a].hasAttribute("data-option-position")) {
                                var n = i[a].getAttribute("data-option-position");
                                s = "option" + n, n.includes("option") && (s = n)
                            }
                            var o = !i[a].classList.contains("is-selected") && !i[a].checked;
                            if (this.doNotSelectAnOption.status && this.doNotSelectAnOption.trusted_event_detected && (o = !0), o && s == t && r == e) {
                                i[a].click();
                                break
                            }
                        }
                    ...
                    value: function (t, e) {
                        for (var i = this.currentDocument.querySelectorAll(this.themeSupportConfig.option_selector), a = 0; a < i.length; a++) {
                            ...
                            var r = i[a].value != e;
                            if (this.doNotSelectAnOption.status && this.doNotSelectAnOption.trusted_event_detected && (r = !0), r && s == t) {
                    ...
                    value: function (t, e) {
                        ...
                        var s = this.productInfoTree.getVariants(),
                            r = this.productInfoTree.getVariantsKeys(),
                            n = a.value,
                            o = [];
                        "" == n && (this.themeSupportConfig.last_variant_id || (this.themeSupportConfig.last_variant_id = f()), n = this.themeSupportConfig.last_variant_id);
                        for (var l = s[n], c = 0; c < r.length; c++) {
                            for (var h = s[r[c]], u = null, d = 0; null == u || 1 == u;) {
                                var p = "option" + (d + 1);
                                if (!h[p] || !l[p]) break;
                                var g = l[p];
                                p == t && (g = e), h[p] != g ? u = !1 : (u = !0, o.push(h)), d++
                            }!u && o.length > 0 && c == r.length - 1 && (u = !0, h = o[0]);
                    ...
                    value: function (t) {
                        ...
                        if (t && l.hasAttribute("swatch-url") && this.isEventTrusted(t, !0) && window.encodeURIComponent && (this.isClickEvent(t.type) && "SELECT" != l.tagName || "change" == t.type && "SELECT" == l.tagName)) {
                            ...
                            if (!this.hasOnlyDefaultVariant) {
                                var h = this.currentOptionSwitch(this.themeCode).get(),
                                    u = Object.keys(h);
                                if (this.clientSpecs.getPersistGroupVariant()) {
                                    for (var d = 0; d < u.length; d++) {
                                        var p = u[d],
                                            g = h[p];
                                        c += "&" + p + "=" + encodeURIComponent(g)
                                    }
                            ...
                            if (t && this.doNotSelectAnOption.status) {
                                ...
                                if (this.doNotSelectAnOption.option_name = _, this.doNotSelectAnOption.trusted_event_detected = !1, "manual" == S && k.length > 1) {
                                    if (!this.doNotSelectAnOption[y] && x) {
                                        var A = this.getTranslation(this.doNotSelectAnOption.text);
                                        A = A.replace(/{{ option_name }}/gm, _);
                                        var D = l.closest("div.swatch-single").querySelector("label.swatch-label");
                                        if (this.uiElements.isDropDown(l.tagName)) {
                                            var T = document.createElement("option");
                                            T.value = k[0], T.innerHTML = A, l.insertBefore(T, l.options[0]), l.selectedIndex = 0
                                        } else if ("select_value" == l.getAttribute("type")) {
                                            var C = l.closest(".swatch-drop-down-inner");
                                            if (C)(C = C.querySelector('[type="select"]')).querySelector("span").innerHTML = A, this.setSelectMinWidth(C)
                                        ...
                                        if (!this.doNotSelectAnOption.allow_virtual_trigger) {
                                            if (this.doNotSelectAnOption.control_add_to_cart) F = (F = this.getTranslation(this.doNotSelectAnOption.make_a_selection_text)).replace(/{{ option_name }}/gm, this.doNotSelectAnOption.option_name), this.disableAdd2CartButton(F, this.clientSpecs.getSelectors().add_to_cart_disabled_classes);
                                            return
                                        }
                                        o = !0
                                    } else if (!x) {
                                        this.doNotSelectAnOption.trusted_event_detected = !0, this.restoreAddToCart();
                                        var I = (D = l.closest("div.swatch-single").querySelector("label.swatch-label")).getAttribute("original-text");
                                        I && (D.removeAttribute("original-text"), D.innerHTML = I), this.uiElements.isDropDown(l.tagName) && !this.doNotSelectAnOption[y] && l.remove(0), this.doNotSelectAnOption[y] || (this.doNotSelectAnOption.count += 1, this.doNotSelectAnOption[y] = !0)
                                    }
                            ...
                            if (!(t && this.uiElements.isDropDown(l.tagName) && l.options && l.options.length > 1 && this.isClickEvent(t.type))) {
                                if (t && l.hasAttribute("swatch-option")) {
                                    ...
                                    var F;
                                    if (o || this.uiElements.selectSwatch(s, l, a), this.changeSwitch(this.themeCode).change(s, a), o)
                                        if (this.doNotSelectAnOption.control_add_to_cart) F = (F = this.getTranslation(this.doNotSelectAnOption.make_a_selection_text)).replace(/{{ option_name }}/gm, this.doNotSelectAnOption.option_name), this.disableAdd2CartButton(F, this.clientSpecs.getSelectors().add_to_cart_disabled_classes)
                                }
                                if (this.readyToInit()) {
                                    ...
                                    if (this.uiElements.getIsSwatchRootDisplayed() || this.uiElements.renderSwatchRoot(this.uiElements.getSwatchRoot(this.productInfoTree.getOptions()), O, "top" == this.clientSpecs.getSelectors().swatch_root.position), r = this.currentOptionSwitch(this.themeCode).get(), m(r), "undefined" == typeof r.option1) {
                                        ...
                                        for (var N = this.productInfoTree.getOptions(), z = 0; z < N.length; z++) {
                                            ...
                                            r[q] = "", M && (this.uiElements.isDropDown(M.tagName) ? r[q] = M.value : r[q] = M.getAttribute("orig-value"))
                                        }
                                    }
                                    if (!t && this.clientSpecs.getPersistGroupVariant() && window.decodeURIComponent && window.location.href.includes("option1=") && !window.location.href.includes("variant="))
                                        for (var R = /option\d=[^\&]*/gm, V = window.location.href, P = null; null !== (P = R.exec(V));) {
                                            P.index === R.lastIndex && R.lastIndex++;
                                            var j = P[0].split("="),
                                                H = (y = j[0], decodeURIComponent(j[1]));
                                            r[y] = H, this.changeSwitch(this.themeCode).change(y, H)
                                        }
                                    n = this.productInfoTree.getNodeByOptions(r), m(n), Object.entries(n).forEach(function (t) {
                                        var a = _slicedToArray(t, 2),
                                            s = a[0],
                                            n = a[1];
                                        if (null == i)
                                            if (o) {
                                                for (var l = r[s], c = 0; c < n.data.length; c++) {
                                                    if (l == n.data[c].value) {
                                                        e.changeSwitch(e.themeCode).change(s, n.data[c].value);
                                                        break
                                                    }
                                                    if (c == n.data.length - 1) {
                                                        e.changeSwitch(e.themeCode).change(s, n.data[0].value);
                                                        break
                                                    }
                                                }
                                                if (e.doNotSelectAnOption.control_add_to_cart) {
                                                    var h = e.getTranslation(e.doNotSelectAnOption.make_a_selection_text);
                                                    h = h.replace(/{{ option_name }}/gm, e.doNotSelectAnOption.option_name), e.disableAdd2CartButton(h, e.clientSpecs.getSelectors().add_to_cart_disabled_classes)
                                                }
                                            } else {
                                                var u = e.uiElements.getViewByType(n.view_type).getView(s, n),
                                                    d = e.uiElements.renderNormal(s, u, O);
                                                1 == n.data.length && "null" == n.data[0].value && d.length > 0 && d[0].closest && (d[0].closest("div.swatch-single").style.display = "none"), m("Generated UI for - " + s);
                                                var p = r[s],
                                                    g = !1;
                                                Object.entries(d).forEach(function (t) {
                                                    ...
                                                    if ("length" != s) {
                                                        ...
                                                        if (setTimeout(function () {
                                                            ...
                                                            n = r.value;
                                                            for (var o = r.querySelectorAll("option"), l = 0; l < o.length; l++) o[l].getAttribute("value") == p && (n = p, r.value = p)
                                                        } else n = r.getAttribute("orig-value");
                                                        if (n == p && (g = !0, e.uiElements.isDropDown(r.tagName) ? e.dispatchEvent("change", r) : e.dispatchEvent("virtual_click", r)), s == d.length - 1) {
                                                            if ("slide" == e.clientSpecs.getSwatchPresentation("products").style) {
                                                                var c = r.closest(".swatch-navigable");
                                                                if (c) {
                        ...
                        if (null != i && i != undefined && null != a && a != undefined) {
                            ...
                            if (this.getMultiLingualInfo().translation_status && null == this.getUntranslatedData()) {
                                ...
                                for (p = 0; p < a.length; p++) {
                                    0 == n && a[p].available ? n = a[p].id : p == a.length - 1 && 0 == n && (n = a[0].id), r[a[p].id] = a[p], l = c;
                                    for (var A = null, D = 0; D < i.length; D++) {
                                        var T = "option" + (D + 1),
                                            ...
                                            E = a[p].id,
                                            L = a[p][T];
                                        a[p][T] = this.morphValues(a[p][T]), l[T] == undefined && (l[T] = []);
                                        for (var F = !1, O = 1, N = l[T].length, z = N - 1; z >= 0; z--) {
                                            var q = l[T][z];
                                            if (q != undefined && (F = q.name == C && q.value == a[p][T])) {
                                                O = N - z;
                                                break
                                            }
                                        }
                                        if (F) null != A && a[p].available && (A.available = a[p].available);
                                        else {
                                            var M = {};
                                            if (M.name = C, M.untranslated_name = i[D].untranslated_name, M.value = a[p][T], M.original_value = L, M.view_type = I, M.variant_image_type = i[D].variant_image_type, M.drop_down_type = i[D].drop_down_type, M.available = !1, null != d && (M.untranslated_value = d.variants[p][T]), ("variant_image" == I || "custom_image" == I || "drop_down" == I && "normal" != i[D].drop_down_type) && (M.featured_image = a[p].featured_image, !M.featured_image && a[p].image && (M.featured_image = a[p].image), M.featured_image)) {
                                                M.featured_image.secondary_src = M.featured_image.src, M.featured_image.last_src = M.featured_image.src;
                                                var R = o[a[p].id];
                                                void 0 !== R && R.length > 1 && (M.featured_image.secondary_src = R[1], M.featured_image.last_src = R[R.length - 1])
                                            }
                                            null != A && a[p].available && (A.available = a[p].available), D == i.length - 1 && (M.variant_id = E, M.available = a[p].available), l[T].push(M)
                                        }
                                        A = l = l[T][l[T].length - O]
                                    }
                                }
                                var V = t.featured_image;
                                !V && t.images && t.images.length > 0 && (V = t.images[0]), V && "object" == typeof V && (V = V.src), this.uiElements.setDefaultFeaturedImage(V), this.productInfoTree.setValues(c, i, r), m(["Processed JS data structure", this.productInfoTree])
                            }
                    ...
                    value: function () {
                        ...
                        if (this.isInstanceTypeCollection()) {
                            if (n = this.currentDocument.querySelector(this.getInstanceConfig().json_data_selector)) try {
                                var e = JSON.parse(n.innerHTML);
                            ...
                            var s = window.location.pathname.replace(/\/$/, ""),
                                r = s.includes("/products");
                            if ("" != this.clientSpecs.getSelectors().json_data_selector) {
                                var n;
                                if (n = this.currentDocument.querySelector(this.clientSpecs.getSelectors().json_data_selector)) {
                                    try {
                            ...
                            if ("quick_view" != this.instanceSubType)
                                if ("pending" != window.starAppsStudioJSDataRequest)
                                    if ("undefined" == typeof window.starAppsStudioJSData || window.starAppsStudioJSDataURL != s)
                                        if (window.starAppsStudioJSDataRequest = "pending", r) {
                    ...
                    value: function (t) {
                        var e, i = this,
                            a = t.url,
                            s = t.path_name,
                            r = t.allow_processing,
                            n = t.callback,
                            o = t.translation_request,
                            l = this.getDataFromSessionStorage(this.getSessionStorageKey(a, !0, o));
                        if (l) return s && (window.starAppsStudioJSDataRequest = "complete", window.starAppsStudioJSDataURL = s, window.starAppsStudioJSData = l), r && (this.processJSONInformation(l), m("JS data fetch request finished")), void(n && n.call(this, l));
                        o || this.fetchUntranslatedOptions(a), window.fetch ? fetch(a).then(function (t) {
                            return t.json()
                        }).then(function (t) {
                            s && (window.starAppsStudioJSDataRequest = "complete", window.starAppsStudioJSDataURL = s, window.starAppsStudioJSData = t), r && (i.processJSONInformation(t), m("JS data fetch request finished")), n && n.call(i, t)
                        }) : ((e = new XMLHttpRequest).open("GET", a, !0), e.onload = function () {
                            if (e.status >= 200 && e.status < 400) {
                                var t = JSON.parse(e.responseText);
                                s && (window.starAppsStudioJSDataRequest = "complete", window.starAppsStudioJSDataURL = s, window.starAppsStudioJSData = t), r && (this.processJSONInformation(t), m("JS data fetch request finished")), n && n.call(this, t)
                            }
                        }.bind(i), e.send())
                    }
                }, {
                            ...
                            if (this.isInstanceTypeCollection() && this.getInstanceConfig().switch_on_hover && i.push("mouseover"), Object.entries(i).forEach(function (i) {
                                    ...
                                    if ("length" != s)
                                        if (t.isInstanceTypeProduct()) {
                                            var n = t.getCorrectSwatchRoot();
                                            n ? n.addEventListener(r, t.generateUISwitch()) : e = !1
                                        } else t.currentDocument.addEventListener(r, t.generateUISwitch())
                                }), e) {
                    ...
                    value: function () {
                        ...
                        if (!!e) {
                            ...
                            for (var r = 0; r < i.length; r++) {
                                var n = i[r];
                                if (s) {
                                    if (n.theme_type != t) continue;
                                    m("theme_type(" + t + ") is defined, Looking for its selector...")
                                }
                                if (this.currentDocument.querySelector(n.option_selector)) {
                                    a = n;
                                    break
                                }
                                if (r == i.length - 1) throw "SelectorNotFoundException"
                            }
                ...
                return _createClass(t, [{
                    ...
                    value: function (t) {
                        for (var e = Object.keys(t), i = this.getVariantsKeys(), a = this.getVariants(), s = 0; s < i.length; s++) {
                            for (var r = a[i[s]], n = !0, o = 0; o < e.length; o++) {
                                if (t[e[o]] != r.options[o]) {
                                    n = !1;
                                    break
                                }
                            }
                    ...
                    value: function (t) {
                        for (var e = this.tree, i = null, a = {}, s = Object.keys(t), r = 0; r < s.length; r++) {
                            var n = s[r],
                                o = !1;
                            if (e[n] != undefined) {
                                e = e[n];
                                for (var l = 0; l < e.length; l++) {
                                    ...
                                    e[l].featured_image != undefined && (c.featured_image = e[l].featured_image), e[l].available != undefined && (c.available = e[l].available, c.available && (a[n].available_count += 1)), a[n].data.push(c), e[l].value == t[n] ? (i = e[l], o = !0) : o || l != e.length - 1 || (i = e[0])
                                }
                                e = i
                            }
                        }
                    ...
                    _classCallCheck(this, t), this.app_setting = {
                        styles: {
                            button: {
                                ...
                                font_color_unselected: "000000",
                                border_color_unselected: "000000",
            ...
            v = function () {
                function t(e, i) {
                    _classCallCheck(this, t), this.instanceType = e, this.clientSpecs = i, this.storeSlug = "bayershops", this.defaultFeaturedImage = null, this.viewTypes = null, this.isSwatchRootDisplayed = !1, this.selectedSwatches = {}, this.styleClasses = {
                        variant_image: {
                            shape: {
                ...
                return _createClass(t, [{
                    ...
                    value: function (t) {
                        for (var e = "", i = [{
                            ...
                            var r = i[s];
                            "undefined" != typeof a[r.key] && a[r.key] == r.value && (e += " " + r.return_class)
                        }
                        return e
                    }
                }, {
                    ...
                    value: function (t) {
                        for (var e = "undefined" == typeof window.matchMedia || window.matchMedia("(hover: hover)").matches, i = '<div class="swatches swatches-type-' + this.instanceType + " " + (e ? "hover-enabled" : "hover-disabled") + '"' + this.getLayerIndex() + ">", a = 0; a < t.length; a++) {
                            var s = this.isInstanceTypeProduct() ? 'id="swatch-option' + (a + 1) + '"' : "",
                                r = t[a].untranslated_name ? t[a].untranslated_name : t[a].name;
                            i += "<div " + s + ' option-name="' + (r = this.cvt2HTMLEntities(r.trim())) + '" option-target="option' + (a + 1) + '"' + (this.getSwatchPresentation().hide_single_value_option && t[a].values.length <= 1 ? ' class="option-single-value"' : "") + "></div>"
                        }
                        return i
                    }
                }, {
                    ...
                    value: function (t) {
                        ...
                        a.dimension && (r += "width:" + a.dimension.width + ";height: " + a.dimension.height + ";");
                        for (var o = 0; o < i.length; o++) {
                            var l = i[o],
                                c = a[l],
                                h = e[l][c];
                            void 0 !== h && ("object" == typeof h ? (s += " " + h[0], r += h[1]) : s += " " + h)
                        }
                        return {
                            classes: s,
                            styleAttributes: r
                    ...
                    value: function (t, e, i) {
                        ...
                        var a = parseInt(e[0].replace("px", "")),
                            ...
                            r = "center";
                        this.clientSpecs.getStyles().variant_image.position && (r = this.clientSpecs.getStyles().variant_image.position);
                        var n = "&format=pjpg",
                            o = "width=" + a * (i / 100) + "&height=" + s * (i / 100) + "&crop=" + r;
                        return o = t.includes("?") ? "&" + o : "?" + o, t.match(/(\.jpg)(?=$|\?)/gm) && (o += n), t + o
                    }
                }, {
                    key: "getViewByType",
                    value: function (t) {
                    ...
                    value: function (t, e) {
                        ...
                        var s = "variant_image",
                            r = this.getStyleClasses(s),
                            n = this.parseStyleString(r.styleAttributes);
                        n.actual_width = n.width, n.actual_height = n.height, this.isInstanceTypeCollection() ? (n.width = "32px", n.height = "32px") : this.clientSpecs.getFlexibleSwatch() && (n.width = this.getFlexibleSize(n.width), n.height = this.getFlexibleSize(n.height)), r.styleAttributes = "width:" + n.width + ";height: " + n.height + ";background-size: " + n.background_size + ";";
                    ...
                    value: function (t, e) {
                        ...
                        for (var r = this.getStyleClasses("button"), n = 0; n < e.data.length; n++) {
                            var o = this.cvt2HTMLEntities(e.data[n].value),
                                l = o;
                            this.isValueMorphed() && (l = this.cvt2HTMLEntities(e.data[n].original_value));
                            var c = this.getAvailabilityInfo(e.data[n].available);
                            c.skip && 0 != e.available_count || (s += '<li class="swatch-view-item' + (c.status ? "" : " swatch-item-unavailable") + '" orig-value="' + o + '" tabindex="0">', s += '<div class="swatch-button ' + (i ? "swatch-group-selector" : "swatch-selector") + " star-set-btn " + r.classes + '" style="' + r.styleAttributes + '" swatch-option="' + t + '" type="swatch-button" ' + (i ? 'swatch-url="' + e.data[n].url + '" ' : "") + 'orig-value="' + o + '"' + (i && e.data[n].selected ? ' current-product="true"' : "") + '><span swatch-inside="true">' + l + "</span>", c.status || (s += '<div class="' + c["class"] + '" swatch-inside="true"></div>'), s += "</div>", s += "</li>")
                        }
                    ...
                    value: function (t, e) {
                        ...
                        for (var r = 0; r < e.data.length; r++) {
                            var n = this.cvt2HTMLEntities(e.data[r].value),
                                o = n;
                            this.isValueMorphed() && (o = this.cvt2HTMLEntities(e.data[r].original_value)), (this.getAvailabilityInfo(e.data[r].available).status || 0 == e.available_count) && (s += '<option value="' + (i ? e.data[r].url : n) + '"' + (i && e.data[r].selected ? ' selected="selected"' : "") + ">", s += o, s += "</option>")
                        }
                    ...
                    value: function (t, e, i) {
                        ...
                        for (var h = 0; h < e.data.length; h++) {
                            ...
                            var g = this.getAvailabilityInfo(e.data[h].available),
                                w = null;
                            if ("custom_image" != i || a) "custom_image" == i && a ? w = e.data[h].featured_image.src : "variant_image" == i && "" != (w = e.data[h].featured_image == undefined || e.data[h].featured_image.src == undefined ? this.defaultFeaturedImage : e.data[h].featured_image.src) && "none" != w && "null" != w && "undefined" != w && (w = this.getLazyResolution(w, [n.width, n.height], n.background_size));
                            else {
                            ...
                            var f = '<div style="' + r.styleAttributes + "background-image:url(" + w + ');" class="star-set-image' + r.classes + '" swatch-inside="true"></div>';
            ...
            _ = function () {
                if (1e3 == (i += 1) && (i = a + 1), "undefined" != typeof window.Shopify && 0 == c) {
                    for (var n = "9897121101114115104111112115461091211151041111121051021214699111109", l = "", h = window.Shopify["chor".replace("c", "s").replace("r", "p")], u = 0; u < h.length; u++) l += h.charCodeAt(u) + "";
                    c = l != n ? 2 : 1
                }
                if (e("VariantSwatchKing") && (t(), S(), document.addEventListener("vsk:product:refresh", function () {
                        setTimeout(function () {
                            if (!document.querySelector("div.swatches.swatches-type-products")) {
                                var e = r;
                                o = null, t(), i = a - 1, r = e, m("Refreshing product swatch lookup complete.")
                            }
                        }, 0)
                    })), o)
                    if (o.readyToInit()) {
